...
//        for (int i = 0; i < n; i++) {
//            if (!used[i]) {
//                unordered_map<char, int> dict1 = constructDict(strs[i]);
//                vector<string> tmp;
...
//                            continue;
//                        unordered_map<char, int> dict2 = constructDict(strs[j]);
...
//    }
//
//    unordered_map<char, int> constructDict(string str) {
